...
public class CurrencyCodeRecord extends UpdatableRecordImpl<CurrencyCodeRecord> implements Record2<String, String> {
    ...
    private static final long serialVersionUID = 1776387949;

    /**
     * Setter for <code>currency_schema.currency_code.code</code>.
     */
    public CurrencyCodeRecord setCode(String value) {
        set(0, value);
        return this;
    }
     ...
     */
    public CurrencyCodeRecord setDescription(String value) {
        set(1, value);
        return this;
    }
