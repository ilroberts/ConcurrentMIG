 ...
 * 2017-10-17T11:28:57.895+01:00
 * Generated source version: 3.2.0
 * 
 */
@WebServiceClient(name = "country", 
                  wsdlLocation = "file:src/main/resources/wsdl/sample.wsdl",
...
public class Country extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:src/main/resources/wsdl/sample.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Country.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:src/main/resources/wsdl/sample.wsdl");
        }
        WSDL_LOCATION = url;
    }
